namespace SampleConApp
{
    ...
    class SonClass : ParentClass
    {
        public void Show()
        {
            Console.WriteLine("This is Show Class");
        }
    ...
    internal class Ex10MethodOverriding
    {
        ...
        static void Main(string[] args)
        {
            ...
            //DownCasting : only method that are defined in PC can be called on PO. If U want to call methods that are defined in SC, U need to downcast the PO to SC using the 'as' keyword or by direct casting.
            if(parent is SonClass)
            {
                SonClass son=parent as SonClass;//DownCasting: treating PC as SC
